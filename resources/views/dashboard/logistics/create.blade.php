    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('logistics.store') }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_barang') is-invalid @enderror"
                                        id="nama_barang" placeholder="Nama Barang" value="{{ old('nama_barang') }}"
                                        name="nama_barang">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('stok_barang') is-invalid @enderror"
                                        id="stok_barang" placeholder="Stok Barang" value="{{ old('stok_barang') }}"
                                        name="stok_barang">
