...
@section('title-header', 'Tambah Data Desa')
@section('breadcrumb')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Desa</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('villages.store') }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_desa') is-invalid @enderror"
                                        id="nama_desa" placeholder="Nama Desa" value="{{ old('nama_desa') }}"
                                        name="nama_desa">
