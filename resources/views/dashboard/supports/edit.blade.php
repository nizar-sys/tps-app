@extends('layouts.app')
@section('title', 'Ubah Data Dukungan')

@section('title-header', 'Ubah Data Dukungan')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('supports.index') }}">Data Dukungan</a></li>
    <li class="breadcrumb-item active">Ubah Data Dukungan</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Data Dukungan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('supports.update', $support->id) }}" method="POST" role="form"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_kepala_keluarga', $support->nama_kepala_keluarga) }}" name="nama_kepala_keluarga">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_telp') is-invalid @enderror"
                                        id="no_telp" placeholder="No HP" value="{{ old('no_telp', $support->no_telp) }}" name="no_telp">
                                    ...
                                    <select class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                        ...
                                        @foreach ($genders as $jenis_kelamin)
                                            <option value="{{ $jenis_kelamin }}"
                                                @if (old('jenis_kelamin', $support->jenis_kelamin) == $jenis_kelamin) selected @endif>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('potensi_suara') is-invalid @enderror"
                                        id="potensi_suara" placeholder="Potensi Suara" value="{{ old('potensi_suara', $support->potensi_suara) }}"
                                        name="potensi_suara">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('long_lat') is-invalid @enderror"
                                        ...
                                        value="{{ old('long_lat', $support->long_lat) }}" name="long_lat">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" class="form-control @error('foto_tampak_depan_rumah') is-invalid @enderror"
                                        id="foto_tampak_depan_rumah" placeholder="Foto Tampak Depan Rumah" name="foto_tampak_depan_rumah">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    id="alamat" placeholder="Alamat" name="alamat" cols="30" rows="5">{{ old('alamat', $support->alamat) }}</textarea>
